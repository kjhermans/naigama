...
#ifndef _NAIGAMA_UTIL_FUNCTIONS_H_
#define _NAIGAMA_UTIL_FUNCTIONS_H_
...
/* declared in ./lib/util/atof_substr.c */
extern
double atof_substr
...
/* declared in ./lib/util/readline.c */
extern
char* readline
  (char* prompt)
  __attribute__ ((warn_unused_result));

/* declared in ./lib/util/slogmem.c */
extern
void flogmem
